...
- 📦 **v1.6 — Polish & UX Refinement** - Phases 43–47 (archived, never executed — superseded by v1.7). See [milestones/v1.6-archive/README.md](milestones/v1.6-archive/README.md)
- 🚧 **v1.7 — Review UX & Access Rewrite** - Phases 43+ (in progress)
